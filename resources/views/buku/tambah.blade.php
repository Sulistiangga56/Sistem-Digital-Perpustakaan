    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="/buku" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group" method="post" action="{{ asset ('files') }}">
                    <label for="files" class="text-primary font-weight-bold">Tambah Data Buku</label>
                    <div class="custom-file">
                        <input type="file" name="files" id="files" value="{{ old('files') }}">
                    </div>
                </div>
