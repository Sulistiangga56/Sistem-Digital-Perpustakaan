...
class DatabaseSeeder extends Seeder
{
    ...
    Kategori::create([
        'nama'=>'Novel',
        'deskripsi' => 'Kumpulan Buku materi Novel'
    ]);
    Kategori::create([
        'nama'=>'Pelajaran',
    ...
    Kategori::create([
        'nama'=>'Rommance',
        'deskripsi' => 'Kumpulan Buku materi Romance'
    ]);
    Kategori::create([
        'nama'=>'Drama',
        'deskripsi' => 'Kumpulan Buku materi Drama'
    ]);
    Kategori::create([
        'nama'=>'Fiksi',
        'deskripsi' => 'Kumpulan Buku materi Fiksi'
    ]);
    Kategori::create([
        'nama'=>'Pemrograman',
        'deskripsi' => 'Kumpulan Buku materi Pemograman'
    ]);
    Kategori::create([
        'nama'=>'Science',
        'deskripsi' => 'Kumpulan Buku materi Science'
    ]);
    Kategori::create([
        'nama'=>'Horror',
        'deskripsi' => 'Kumpulan Buku materi Horor'
    ]);
    Buku::create([
        'kode_buku'=>'LSK-01',
